        ...
        <table class="header-table">
            <tr>
                ...
                <td width="30%" class="text-center">
                    ...
                    <div style="font-size: 20px; margin-top: 15px; font-weight: bold; text-decoration: underline;">VENTE</div>
                </td>
            ...
            <tr>
                <td class="info-box">
                    ...
                    <div class="box-content">
                        <strong>Référence :</strong> {{ $vente->reference ?? '#' . $vente->id }}<br>
                        <strong>Date :</strong> {{ $vente->date }}<br>
                        <strong>Client :</strong> {{ $vente->client?->name ?? '-' }}<br>
                        <strong>Statut :</strong> {{ $vente->status_label }}
                    </div>
                </td>
            </tr>
        </table>
